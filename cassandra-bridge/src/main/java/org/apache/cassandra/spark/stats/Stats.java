...
public abstract class Stats<T extends SSTable>  implements IStats<T>
{
     ...
     */
    public void inputStreamQueueFull(Source<? extends SSTable> ssTable)
    {
    }
     ...
     */
    public void inputStreamFailure(Source<T> ssTable, Throwable throwable)
    {
    }

    /**
     * Time the {@link BufferingInputStream} spent blocking on queue
     * waiting for bytes. High time spent blocking indicates the job is network-bound, or blocked on the
     * {@link Source} to supply the bytes.
     *
     * @param ssTable the SSTable source for this input stream
     * @param nanos   time in nanoseconds
     */
    public void inputStreamTimeBlocked(Source<T> ssTable, long nanos)
    {
    }

    /**
     * Bytes written to {@link BufferingInputStream}
     * by the {@link Source}
     *
     * @param ssTable the SSTable source for this input stream
     * @param length  number of bytes written
     */
    public void inputStreamBytesWritten(Source<T> ssTable, int length)
    {
    }
     ...
     */
    public void inputStreamByteRead(Source<T> ssTable,
                                    int length,
                                    int queueSize,
                                    int percentComplete)
    {
    ...
    /**
     * {@link Source} has finished writing
     * to {@link BufferingInputStream} after reaching expected file length
     *
     * @param ssTable the SSTable source for this input stream
     */
    public void inputStreamEndBuffer(Source<T> ssTable)
    {
    }
     ...
     */
    public void inputStreamEnd(Source<T> ssTable, long runTimeNanos, long totalNanosBlocked)
    {
    }
     ...
     */
    public void inputStreamBytesSkipped(Source<T> ssTable,
