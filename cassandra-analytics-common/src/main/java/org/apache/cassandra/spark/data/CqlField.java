...
//        Object toSparkSqlType(Object value, boolean isFrozen);
        ...
        default Object deserialize(TypeConverter decoder, ByteBuffer buffer)
        {
            return deserialize(decoder, buffer, isFrozen());
        }

        default Object deserialize(TypeConverter decoder, ByteBuffer buffer, boolean isFrozen)
        {
            Object value = deserialize(buffer, isFrozen);
            return value != null ? decoder.convert(this, value) : null;
        }

        default Object deserialize(ByteBuffer buffer)
        {
            return deserialize(buffer, isFrozen());
        }
...
//        Object sparkSqlRowValue(Row row, int position);
        ...
        static CqlType read(Input input, CassandraTypes types)
        {
            InternalType internalType = InternalType.values()[input.readInt()];
            return types.readType(internalType, input);
        }
    }
    ...
    public interface CqlUdt extends CqlType
    {
        ...
        String createStatement(CassandraTypes types, String keyspace);
    ...
    public Object deserialize(TypeConverter typeConverter, ByteBuffer buffer)
    {
        return deserialize(typeConverter, buffer, false);
    }

    public Object deserialize(TypeConverter typeConverter, ByteBuffer buffer, boolean isFrozen)
    {
        return type().deserialize(typeConverter, buffer, isFrozen);
    }
    ...
    public static class Serializer extends com.esotericsoftware.kryo.Serializer<CqlField>
    {
        ...
        public Serializer(CassandraTypes types)
        {
            this.types = types;
        }
